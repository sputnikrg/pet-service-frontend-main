            ...
            <div className="relative bg-white p-6 rounded-lg shadow-lg w-80">
                ...
                <form>
                    ...
                    <div className='mt-4'>
                        ...
                        <label className='text-sm'> I consent to the processing of my personal data in accordance with the Privacy Policy .
                            Please treat the checked box next to this statement as my written consent</label>
                    </div>
                    <div className='mt-4'>
                        <input type="checkbox" id="policy" name="policy" />
                        <label className='text-sm'> I have read and agree to the Terms of Use and Privacy Policy</label>
                    </div>
                    <button
                        type="submit"
